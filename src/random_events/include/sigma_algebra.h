...
typedef std::set<AbstractSimpleSet *, PointerLess<AbstractSimpleSet>> SimpleSetSet_t;
//typedef std::set<AbstractSimpleSet *> SimpleSetSet_t;
...
public:
    ...
    */
    virtual SimpleSetSet_t *complement() const = 0;
    ...
    */
    SimpleSetSet_t *difference_with(const AbstractSimpleSet *other) const {
        ...
        if (intersection->is_empty()) {
            const auto result = new SimpleSetSet_t;
        ...
        auto *difference = new SimpleSetSet_t;
    ...
    //virtual bool equal_to(const AbstractSimpleSet &other) const = 0;
...
public:
    ...
    */
    ...
    AbstractCompositeSet *intersection_with(const SimpleSetSet_t &other) const {
        AbstractCompositeSet *result = make_new_empty(all_elements);
        for (const auto current_simple_set: simple_sets) {
